...
## JAR download
The latest JAR can be downloaded from [here](https://repo1.maven.org/maven2/io/minio/minio/9.0.1/)
...
```sh
$ javac -cp minio-9.0.1-all.jar FileUploader.java
```

#### Run FileUploader
```sh
$ java -cp minio-9.0.1-all.jar:. FileUploader
