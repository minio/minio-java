...
## Download from JAR
You can download the latest [JAR](http://repo1.maven.org/maven2/io/minio/minio/3.0.12/) directly from maven.
...
```sh
javac -cp "minio-3.0.12-all.jar"  FileUploader.java
```

#### Run FileUploader
```sh
java -cp "minio-3.0.12-all.jar:." FileUploader
