...
```xml
dependencies {
    compile 'io.minio:minio:6.0.9'
}
```

## Download from JAR
You can download the latest [JAR](http://repo1.maven.org/maven2/io/minio/minio/6.0.9/) directly from maven.
...
```sh
javac -cp "minio-6.0.9-all.jar"  FileUploader.java
```

#### Run FileUploader
```sh
java -cp "minio-6.0.9-all.jar:." FileUploader
