...
## JAR download
The latest JAR can be downloaded from [here](https://repo1.maven.org/maven2/io/minio/minio/8.5.7/)
...
```sh
$ javac -cp minio-8.5.7-all.jar FileUploader.java
```

#### Run FileUploader
```sh
$ java -cp minio-8.5.7-all.jar:. FileUploader
