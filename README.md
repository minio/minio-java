...
```xml
dependencies {
    compile 'io.minio:minio:5.0.4'
}
```

## Download from JAR
You can download the latest [JAR](http://repo1.maven.org/maven2/io/minio/minio/5.0.4/) directly from maven.
...
```sh
javac -cp "minio-5.0.4-all.jar"  FileUploader.java
```

#### Run FileUploader
```sh
java -cp "minio-5.0.4-all.jar:." FileUploader
