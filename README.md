...
```xml
dependencies {
    compile 'io.minio:minio:5.0.5'
}
```

## Download from JAR
You can download the latest [JAR](http://repo1.maven.org/maven2/io/minio/minio/5.0.5/) directly from maven.
...
```sh
javac -cp "minio-5.0.5-all.jar"  FileUploader.java
```

#### Run FileUploader
```sh
java -cp "minio-5.0.5-all.jar:." FileUploader
