...
```gradle
dependencies {
    compile 'io.minio:minio:1.0.0'
}
```

## Download from JAR

You can download the latest [JAR](http://repo1.maven.org/maven2/io/minio/minio/1.0.0/) directly from maven.
...
NOTE: `minio-1.0.0-all.jar` includes all the necessary dependencies to run these examples.
...
$ cd minio-java/examples; wget http://repo1.maven.org/maven2/io/minio/minio/1.0.0/minio-1.0.0-all.jar;
