...
public class RemoveObjectsWithVersion {
  /** MinioClient.removeObjectsWithVersion() example removing multiple objects. */
  public static void main(String[] args)
    ...
    try {
      ...
      // Remove object deleteObjects list from 'my-bucketname'.
