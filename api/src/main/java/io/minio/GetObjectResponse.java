...
/**
 * Response of {@link MinioAsyncClient#getObject} and {@link MinioClient#getObject}. As it is {@link
 * InputStream} interface compatible, it must be closed after use to release underneath network
 * resources.
 */
