...
/**
 * Base provider of {@link LdapIdentityProvider}, {@link CertificateIdentityProvider}, {@link
 * WebIdentityClientGrantsProvider} and {@link AssumeRoleProvider}.
 */
public abstract class BaseIdentityProvider implements Provider {
  ...
  protected HttpUrl.Builder newUrlBuilder(
    ...
    if (policy != null) urlBuilder.addQueryParameter("Policy", policy);
    if (roleArn != null) urlBuilder.addQueryParameter("RoleArn", roleArn);
    if (roleSessionName != null) urlBuilder.addQueryParameter("RoleSessionName", roleSessionName);
  ...
  /** Response to get credentials of {@link BaseIdentityProvider}. */
