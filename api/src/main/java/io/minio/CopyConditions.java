...
public class CopyConditions {
	...
	/**
	 * Returns true if the object is modified after the "modified after 
	 * condition" or modified condition is not set. Else returns false.
	 */
	...
	/**
	 * Returns true if the object is not modified after the unmodified 
	 * since condition or unmodified condition is not set. Else returns false.
	 */
	...
	/**
	 * Returns true if the object etag matches the etag to match condition, 
	 * or etag to match condition is not set. Else returns false.
	 */
	...
	/**
	 * Returns true if the object etag doesn't match the etag not to match condition, 
	 * or etag not to match condition is not set. Else returns false.
	 */
