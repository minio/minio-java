...
/**
 * Helper class to generate Amazon AWS S3 request XML for SelectObjectContentRequest/OutputSerialization information.
 */
...
public class OutputSerialization extends XmlEntity {
   ...
   */
  public static OutputSerialization csv(Character fieldDelimiter, Character quoteCharacter,
                                        Character quoteEscapeCharacter, QuoteFields quoteFields,
                                        Character recordDelimiter) throws XmlPullParserException {
    OutputSerialization os = new OutputSerialization();
    os.csv = new CsvOutputSerialization(fieldDelimiter, quoteCharacter, quoteEscapeCharacter, quoteFields,
                                        recordDelimiter);
    return os;
  }
