...
public class MinioClientTest {
  ...
  @Test(expected = OnlyMinioSupportException.class)
  public void throwsWhenUsingAdminMethodsOnAws()
      throws InternalException, NoSuchAlgorithmException, IOException, OnlyMinioSupportException,
          InvalidCipherTextException, InsufficientDataException, InvalidKeyException {
    MinioClient client =
        MinioClient.builder()
  ...
  //            throws InternalException, NoSuchAlgorithmException, IOException,
  // InvalidCipherTextException,
  //            InsufficientDataException, InvalidKeyException, OnlyMinioSupportException {
  ...
  // [\"s3:GetObject\"],\"Effect\": \"Allow\",\"Resource\":
  // [\"arn:aws:s3:::my-bucketname/*\"],\"Sid\": \"\"}]}")
  //                        .build());
